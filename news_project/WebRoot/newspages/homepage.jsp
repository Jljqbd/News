...
<div id="header">
  ...
  <div id="status">管理员：<%=udata.username %>  &#160;&#160;&#160;&#160; <a href="UserServlet?opr=jumplogin">login out</a> &#160;&#160;&#160;&#160;<a href="UserServlet?opr=jumpadmin">个人主页</a></div>
  <div id="channel"><form action="UserServlet?opr=likesearch" method="post">
  		<label>搜索</label>
  		<input type="text" name="data" class="login_input" />
		&nbsp;&nbsp;用户 
		<input type="radio" checked="checked" name="object" value="username" />
		&nbsp;&nbsp;新闻 
		<input type="radio" name="object" value="title" /></form> </div>
</div>
  </div>
  <div id="nav">
